...
$result[] = array('CAPTION'=>t('font'),'TYPE'=>'font','PROP'=>'font','CLASS'=>'TFont','UPDATE_DSGN'=>1);
...
$result[] = array('CAPTION'=>'??????? ??????','TYPE'=>'check','PROP'=>'running_line','ADD_GROUP'=>true);
$result[] = array('CAPTION'=>'? ????? ????????','TYPE'=>'check','PROP'=>'Left_running_line','ADD_GROUP'=>true);
