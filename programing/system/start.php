<?
    ...
    define('DS_USERDIR',winLocalPath(CSIDL_PERSONAL).'/DevelStudio CE/' );
    ...
    define_ex('DV_YEAR', 2015);
    define_ex('DV_VERSION', '4.0');
    define_ex('DV_PREFIX','CE');
    if (!EMULATE_DVS_EXE){
        loader::lib('data');
    ...
    setTimeout(1000, 'myCompile::setStatus("Info", "Добро пожаловать в DevelStudio CE!");');
