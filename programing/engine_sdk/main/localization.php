...
class Localization {
	...
	Localization::setMsgArr($__M); unset ($__M);
	unset($xml);
    }
    ...
    if (!defined('IS_THREAD')){
        v('__LANG_MESSAGES', $GLOBALS['__LANG_MESSAGES']);
        Thread::addCode('$GLOBALS["__LANG_MESSAGES"] = v("__LANG_MESSAGES");');
    }
